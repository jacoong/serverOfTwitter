...
function googleStrategy(passport) {
    passport.use(new GoogleStrategy({
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userInfo, user, data, addNewUser, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('bbb', email._json);
                        userInfo = email._json;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, userSchema_1.User.findOne({ email: userInfo.email })];
                    case 2:
                        user = _a.sent();
                        if (!(user === null)) return [3 /*break*/, 4];
                        data = { profileImg: userInfo.picture, email: userInfo.email, username: userInfo.name };
                        addNewUser = new userSchema_1.User(data);
                        return [4 /*yield*/, addNewUser.save()];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, cb(null, addNewUser)];
