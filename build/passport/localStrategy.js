        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    exUser = _a.sent();
                    if (!exUser) {
                        return [2 /*return*/, done(null, false, { message: 'Not existing ID' })];
                    }
                    return [4 /*yield*/, (0, passwordBcrypt_1.comparePassword)(password, exUser.password)];
                case 2:
                    match = _a.sent();
                    if (match) {
                        return [2 /*return*/, done(null, exUser)]; // 검증 성공
                    }
                    else {
                        return [2 /*return*/, done(null, false, { message: 'Your password is wrong' })]; // 임의 에러 처리
                    }
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
